...
function ItemsPage() {
    ...
    const applyFilter = () => {
        ...
        const filteredResult = ItemRecords.filter((item) => {
            ...
            return (itemNameMatches || searchItemName === "") && (itemTypeMatches || searchItemType === "") && (itemCategoryMatches || searchItemCategory === "") && (itemCodeMatches || searchItemCode === "")
        });
                                        ...
                                        <div className="col-sm-6 col-md-6 col-lg-3 col-xl-3 col-xxl-3" key={item._id}>
                                            <div className="card itemCard">
                                                ...
                                                <div className='card-footer'>
                                                    <div className="row">
                                                        <div className="col"><button className="btn btn-dark w-100" onClick={() => { addToCart(item.itemCode, item._id) }}><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" className="bi bi-cart-plus-fill" viewBox="0 0 20 20">
                                                            <path d="M.5 1a.5.5 0 0 0 0 1h1.11l.401 1.607 1.498 7.985A.5.5 0 0 0 4 12h1a2 2 0 1 0 0 4 2 2 0 0 0 0-4h7a2 2 0 1 0 0 4 2 2 0 0 0 0-4h1a.5.5 0 0 0 .491-.408l1.5-8A.5.5 0 0 0 14.5 3H2.89l-.405-1.621A.5.5 0 0 0 2 1zM6 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0m7 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0M9 5.5V7h1.5a.5.5 0 0 1 0 1H9v1.5a.5.5 0 0 1-1 0V8H6.5a.5.5 0 0 1 0-1H8V5.5a.5.5 0 0 1 1 0" />
                                                        </svg> Add to Cart</button></div>
                                                        <div className="col"><button className="btn btn-dark w-100" onClick={() => { addToWishlist(item.itemCode, item._id) }}><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" className="bi bi-heart-fill" viewBox="0 0 20 20">
                                                            <path fillRule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314" />
                                                        </svg> Wishlist</button></div>
                                                    </div>
                                                    {/* <div className="row mb-2">
                                                        <div className="col">
                                                            <button className="btn btn-dark w-100" onClick={() => { buyNow(item.itemCode, item._id) }}><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" className="bi bi-bag-fill" viewBox="0 0 20 20">
